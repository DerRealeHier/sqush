...
BADGE_DEFINITIONS = {
    ...
    "comic_crafter": {
        "key": "comic_crafter",
        "name": "Card Crafter",
        "description": "Recycled duplicate comic cards in the crafting forge",
        "icon": "bi-hammer",
        "color": "#ff9f1c",
        "category": "crafting",
        "tier": "bronze",
    ...
    "holo_hero": {
        "key": "holo_hero",
        "name": "Holo Hero",
        "description": "Forged rare duplicate comic cards into custom hero badge",
    ...
    "comic_alchemist": {
        "key": "comic_alchemist",
        "name": "Comic Alchemist",
        "description": "Transmuted epic and legendary duplicate cards into gold",
        "icon": "bi-magic",
        "color": "#9b51e0",
        "category": "crafting",
        "tier": "gold",
    ...
    "comic_trader": {
        "key": "comic_trader",
        "name": "Homie Trader",
        "description": "Swapped collectible cards with a friend via DMs",
